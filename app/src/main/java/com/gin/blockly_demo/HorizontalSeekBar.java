...
public class HorizontalSeekBar extends PercentRelativeLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.isFirst) {
            ...
            this.thumb_hor_line_over = (ImageView) findViewById(R.id.thumb_hor_line_over);
    ...
    private void setThumb(float x) {
        ...
        LayoutParams layoutParams = (LayoutParams) this.thumb_hor_line_over.getLayoutParams();
        layoutParams.width = (int) x;
        this.thumb_hor_line_over.setLayoutParams(layoutParams);
