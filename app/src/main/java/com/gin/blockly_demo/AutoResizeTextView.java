...
public class AutoResizeTextView extends AppCompatTextView {
    ...
    private boolean wrap_content_type;
    ...
    public AutoResizeTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.wrap_content_type = false;
        this._minTextSize = TypedValue.applyDimension(2, 5.0f, getResources().getDisplayMetrics());
    ...
    private void adjustTextSize() {
        if (this._initialized) {
            ...
            if (this._widthLimit > 0) {
                ...
                if (this.wrap_content_type) {
                    this._availableSpaceRect.right = 2.14748365E9f;
                }
    ...
    public void setWrapContentType(boolean wrap_content_type) {
        this.wrap_content_type = wrap_content_type;
    }
}
